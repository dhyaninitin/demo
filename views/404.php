...
body {
  ...
  width: 100%;
  margin: 0px; */
  background: linear-gradient(90deg, rgba(47,54,64,1) 10%, rgba(24,27,32,1) 40%);
}
...
<div class="error">
  ...
  <div class="error__subtitle">! ooops,Page Not Found</div>
  <div class="error__description">It looks like one of the  developers fell asleep</div>
  <a href="login"><button class="error__button error__button--active">LOGIN</button></a>
...
<div class="astronaut">
  ...
  <div class="astronaut__cord">
    <canvas id="cord" height="200px" width="200px"></canvas>
  </div>
